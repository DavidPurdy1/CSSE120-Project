...
Authors:  Your professors (for the framework)
    and Arvind Krishnan, David Purdy, and Charles Falcone.
...
def run_test_go_straight_for_inches(robot):
    ...
    # -------------------------------------------------------------------------
    # Done: 2. The following makes a LIST of PAIRS, where each PAIR specifies
    ...
    for k in range(len(inches_speeds)):
        ...
        # ---------------------------------------------------------------------
        # Done: 3. To make the movement happen, call the
...
def run_test_spin_in_place_for_degrees(robot):
    ...
    for k in range(len(degrees_speeds)):
        ...
        robot.drive_system.spin_in_place_for_degrees(degrees_robot_should_spin,speed)
