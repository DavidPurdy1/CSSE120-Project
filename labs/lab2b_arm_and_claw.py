...
def run_test_calibrate(robot):
    ...
    try:
        # ---------------------------------------------------------------------
        # : 4. Replace the  pass  statement below with a call to
...
def run_test_raise_and_lower():
    ...
    try:
        ...
        # ---------------------------------------------------------------------
        # : 5. Replace the  pass  statement below with a call to
        ...
        # ---------------------------------------------------------------------
        # : 6. Replace the  pass  statement below with a call to
        ...
        # ---------------------------------------------------------------------
        # : 7. Replace the  pass  statement below with a call to
        #  the   lower_arm   method on the arm_and_claw of the given RoseBot.
        #  Then print a simple message like "Lowered!"
        # ---------------------------------------------------------------------
        robot.arm_and_claw.lower_arm()
...
def run_test_move_arm_to_position():
    ...
    try:
        for k in range(len(positions)):
            ...
            # -----------------------------------------------------------------
            #: 8. Replace the  pass  statement below with a call to
