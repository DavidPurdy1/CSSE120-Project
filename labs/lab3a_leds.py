...
Authors:  Your professors (for the framework)
    and David Purdy & Charles Falcone.
...
def run_test_leds_on_off(robot):
    ...
    try:
        while True:
            ...
            # -----------------------------------------------------------------
            robot.leds.set_color("right", "red")
            robot.leds.set_color("left", "red")
...
def run_test_leds_colors(robot):
    ...
    # -------------------------------------------------------------------------
    # : 5. Call the  set_color  method of the   leds   of the robot,
    ...
    try:
        while True:
            for k in range(len(left_colors)):
                ...
                input("Press the ENTER key when ready to change LEDs.")
