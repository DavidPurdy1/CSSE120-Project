...
Authors:  Your professors (for the framework)
    and Arvind Krishnan, David Purdey, Charles Falcone.
...
# -----------------------------------------------------------------------------
# DOne: 2. Note below how to write an IMPORT statement
...
def main():
    ...
    # -------------------------------------------------------------------------
    # Done: 3. The following constructs a RoseBot object, then sends it as an
...
def run_test_go_stop(robot):
    ...
    # -------------------------------------------------------------------------
    # Done: 4. The following makes a LIST of PAIRS, where each pair specifies
    ...
    for k in range(len(speeds)):
        ...
        # ---------------------------------------------------------------------
        # Done: 5.  Implement the following three statements
...
def run_test_go_straight_for_seconds(robot):
    ...
    # -------------------------------------------------------------------------
    # Done: 6. The following makes a LIST of PAIRS, where each PAIR specifies
    ...
    for k in range(len(seconds_speeds)):
        ...
        # ---------------------------------------------------------------------
        # Done: 7. To make the movement happen, call the
