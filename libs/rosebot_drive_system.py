...
class DriveSystem(object):
    ...
    """
    # -------------------------------------------------------------------------
    # : 3. Read and digest the following NOTE:
    ...
    def __init__(self, left_motor_port="B", right_motor_port="C"):
        ...
        """
        # ---------------------------------------------------------------------
        # : 4. Read the following, ASKING QUESTIONS AS NEEDED.
    ...
    def go(self, left_wheel_speed, right_wheel_speed):
        ...
        """
        # ---------------------------------------------------------------------
        # : 5. Implement this method, using code like this:
        ...
        # ---------------------------------------------------------------------
        self.left_motor_speed = ev3dev.Motor.turn_on(self.left_motor, left_wheel_speed)
        self.right_motor_speed = ev3dev.Motor.turn_on(self.right_motor, right_wheel_speed)
    ...
    def stop(self, stop_action="brake"):
        ...
        """
        # ---------------------------------------------------------------------
        # : 6. Implement this method, using code like this:
        #      self.left_motor.YOU_FIGURE_OUT_WHAT_GOES_HERE
        #      self.right_motor.YOU_FIGURE_OUT_WHAT_GOES_HERE
        #  The "dot trick" should make it clear what to put in the YOU_FIGURE...
        # ---------------------------------------------------------------------
        self.left_motor_speed = ev3dev.Motor.turn_off(self.left_motor, stop_action)
        self.right_motor_speed = ev3dev.Motor.turn_off(self.right_motor, stop_action)
    ...
    def go_straight_for_seconds(self, seconds, speed=50, stop_action="brake"):
        ...
        # ---------------------------------------------------------------------
        # : 7. Implement this method, using three lines of code like this:
    ...
    def go_straight_for_inches(self, inches, speed=50, stop_action="brake"):
        ...
        # ---------------------------------------------------------------------
        # : 8. Implement this method, using the following algorithm:
        ...
        # ---------------------------------------------------------------------
        self.motor_pos_inches = 0
        if inches > 0:
            while self.motor_pos_inches < inches:
                self.go(speed, speed)
                time.sleep(.05)
                self.motor_pos_inches = self.left_motor.get_position() / 80

            self.stop(stop_action)

        else:
            print('error: inches <= 0')
    ...
    def spin_in_place_for_seconds(self, seconds, speed=50, stop_action="brake"):
        ...
        # ---------------------------------------------------------------------
        # : 9. Implement this method, using three lines of code like this:
    ...
    def spin_in_place_for_degrees(self, degrees, speed=50, stop_action="brake"):
        ...
        # ---------------------------------------------------------------------
        # : 10. Implement this method, using the following algorithm:
        #   1. Compute the number of DEGREES that the MOTORS should SPIN
        ...
        #             hardware/software of the encoder.
        # ---------------------------------------------------------------------
        self.motor_degrees = 0
        if degrees > 0:
            while self.motor_degrees < degrees:
                self.go(speed, speed)
                time.sleep(.05)
                self.motor_degrees = self.left_motor.get_position() / 6
            self.stop(stop_action)
    ...
    def turn_for_seconds(self, seconds, speed=50, stop_action="brake"):
        ...
        # ---------------------------------------------------------------------
        # : 11. Implement this method, using three lines of code like this:
        #    1. Start both wheel-motors moving:
    ...
    def turn_for_degrees(self, degrees, speed=50, stop_action="brake"):
        ...
        # ---------------------------------------------------------------------
        # : 12. Implement this method, using the following algorithm:
